...
int validate_system_limits(void) {
    ...
    if (sys_config.max_voters <= 0 || sys_config.max_voters > 100000) return 0;
    if (sys_config.max_candidates <= 0 || sys_config.max_candidates > 10000) return 0;
    if (sys_config.min_votes_for_parliament <= 0) return 0;
    if (sys_config.max_parliament_members <= 0 || sys_config.max_parliament_members > 1000) return 0;
    if (sys_config.max_parties <= 0 || sys_config.max_parties > 200) return 0;
    if (sys_config.max_districts <= 0 || sys_config.max_districts > 100) return 0;
