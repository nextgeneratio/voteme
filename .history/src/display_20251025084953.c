	...
	for (;;)
	{
		...
		case '2':
			...
			else
			{
				...
				printf(CYAN_ON_BLACK "Tip: build it or use Admin to manage candidates." RESET_COLORS "\n");
				printf(RED_ON_BLACK "...PRESS ENTER TO RETURN..." RESET_COLORS "\n");
				clearinputbuff();
				getchar();
			}
		...
		case '3':
			...
			else
			{
				...
				printf(CYAN_ON_BLACK "Tip: run voting UI build or use Admin to manage voters." RESET_COLORS "\n");
				printf(RED_ON_BLACK "...PRESS ENTER TO RETURN..." RESET_COLORS "\n");
				clearinputbuff();
				getchar();
			}
